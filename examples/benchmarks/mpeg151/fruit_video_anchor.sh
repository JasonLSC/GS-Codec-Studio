...
run_experiment() {
    ...
    CUDA_VISIBLE_DEVICES=${gpu_id} python compress_ply_sequence.py x265_compression_rp${rp_id} \
        --data_factor 1 \
        --ply_dir /work/Users/lisicheng/Dataset/GSC_splats/m71903_bust_dataset/trained_models/fruit/ \
        --data_dir /work/Users/lisicheng/Dataset/GSC_splats/m71903_bust_dataset/colmap_data/fruit/ \
        --result_dir results/mpeg151/video_anchor/fruit/rp${rp_id} \
        --frame_num 16 \
        --lpips_net vgg \
