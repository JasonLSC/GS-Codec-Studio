...
EXP_DIR=results/mpeg151/video_anchor_1f/cinema
...
run_experiment() {
    ...
    CUDA_VISIBLE_DEVICES=${gpu_id} python compress_ply_sequence.py x265_compression_rp${rp_id} \
        --data_factor 1 \
        --ply_dir /work/Users/lisicheng/Dataset/GSC_splats/m71763_cinema_stable/track \
        --data_dir /work/Users/lisicheng/Dataset/GSC_splats/m71763_cinema_stable/colmap_data \
