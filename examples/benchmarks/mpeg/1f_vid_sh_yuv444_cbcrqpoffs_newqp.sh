...
EXP_DIR=results/cfp_explorations/1f_vid/sh_yuv444_cbcrqpoffs_newqp
...
run_experiment() {
    ...
    CUDA_VISIBLE_DEVICES=${gpu_id} python compress_ply_sequence.py seq_yuv_compression_newqp_rp${rp_id} \
        --data_factor 1 \
        ...
        --compression_cfg.chroma_subsampling.shN 444 \
