...
class Config:
    ...
    save_steps: List[int] = field(default_factory=lambda: [i for i in range(9_000, 60_001, 10_000)]) # Steps to save the model
    eval_steps: List[int] = field(default_factory=lambda: [i for i in range(0, 60_001, 10_000)]) # Steps to evaluate the model # 7_000, 30_000
