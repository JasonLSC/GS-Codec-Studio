...
# ============================================================================
# Multi Rate Point Experiment Script for Mip-NeRF 360 Dataset
# ============================================================================
...
#
# Usage:
#   bash examples/scripts/static_exps/mip/train_multi_ratepoint.sh [RD_LAMBDA_1 RD_LAMBDA_2 ...]
#
# Examples:
#   # Use default rate points
#   bash examples/scripts/static_exps/mip/train_multi_ratepoint.sh
#
#   # Custom rate points
#   bash examples/scripts/static_exps/mip/train_multi_ratepoint.sh 0.01 0.05 0.1
# ============================================================================
