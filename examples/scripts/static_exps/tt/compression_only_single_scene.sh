...
# ============================================================================
# Compression-Only Single Scene Script for Tanks and Temples Dataset
# ============================================================================
# 用法:
#   bash examples/scripts/static_exps/tt/compression_only_single_scene.sh \
#        <SCENE> <GPU_ID> [RD_LAMBDA] [CONFIG_FILE]
#
# 示例:
#   bash examples/scripts/static_exps/tt/compression_only_single_scene.sh train 0
#   bash examples/scripts/static_exps/tt/compression_only_single_scene.sh truck 1 0.01 examples/configs/mcmc_comp_sim.yaml
# ============================================================================
