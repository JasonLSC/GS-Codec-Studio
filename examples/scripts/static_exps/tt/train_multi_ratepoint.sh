...
# ============================================================================
# Multi Rate Point Experiment Script for Tanks and Temples Dataset
# ============================================================================
...
#
# Usage:
#   bash examples/scripts/static_exps/tt/multi_ratepoint.sh [RD_LAMBDA_1 RD_LAMBDA_2 ...]
#
# Examples:
#   # Use default rate points
#   bash examples/scripts/static_exps/tt/multi_ratepoint.sh
#
#   # Custom rate points
#   bash examples/scripts/static_exps/tt/multi_ratepoint.sh 0.01 0.05 0.1
# ============================================================================
...
for RD_LAMBDA in "${RD_LAMBDA_LIST[@]}"; do
    ...
    bash examples/scripts/static_exps/tt/train_single_ratepoint.sh $RD_LAMBDA
