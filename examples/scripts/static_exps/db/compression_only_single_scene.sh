...
# ============================================================================
# Compression-Only Single Scene Script for Deep Blending Dataset
# ============================================================================
# 用法:
#   bash examples/scripts/static_exps/db/compression_only_single_scene.sh \
#        <SCENE> <GPU_ID> [RD_LAMBDA] [CONFIG_FILE]
#
# 示例:
#   bash examples/scripts/static_exps/db/compression_only_single_scene.sh drjohnson 0
#   bash examples/scripts/static_exps/db/compression_only_single_scene.sh playroom 1 0.01 examples/configs/mcmc_comp_sim.yaml
# ============================================================================
